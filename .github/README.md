...
[`@aws-sdk/client-bcm-recommended-actions`](https://www.npmjs.com/package/@aws-sdk/client-bcm-recommended-actions/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CxDMjF4L5TkaMjG209o/+JIVOthYkIibZpmv8C8Rz9YEUUocMickoRCyfhMJz+FW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bcm-recommended-actions": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.952.0/index.min.mjs": "sha384-CxDMjF4L5TkaMjG209o/+JIVOthYkIibZpmv8C8Rz9YEUUocMickoRCyfhMJz+FW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bcm-recommended-actions/blob/refs/tags/3.952.0/LICENSE
```
