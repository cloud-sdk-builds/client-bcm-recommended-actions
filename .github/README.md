...
[`@aws-sdk/client-bcm-recommended-actions`](https://www.npmjs.com/package/@aws-sdk/client-bcm-recommended-actions/v/3.1108.0).
...
- @aws-sdk/client-bcm-recommended-actions - [https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions](https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions)
- @aws-sdk/client-bcm-recommended-actions v3.1108.0 - [https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions&version=3.1108.0](https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions&version=3.1108.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1108.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T3bde48Cub112XlLViA8zodcPtpZ9BRaTnhEr5hoSjMYB30NCQR+FigRjRINrCuC
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bcm-recommended-actions": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1108.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1108.0/index.min.mjs": "sha384-T3bde48Cub112XlLViA8zodcPtpZ9BRaTnhEr5hoSjMYB30NCQR+FigRjRINrCuC"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-bcm-recommended-actions";
...
```
https://github.com/cloud-sdk-builds/client-bcm-recommended-actions/blob/refs/tags/3.1108.0/LICENSE
```
