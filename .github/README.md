...
[`@aws-sdk/client-bcm-recommended-actions`](https://www.npmjs.com/package/@aws-sdk/client-bcm-recommended-actions/v/3.1114.0).
...
- @aws-sdk/client-bcm-recommended-actions v3.1114.0 - [https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions&version=3.1114.0](https://cloud-sdk-builds.github.io/?sdk=client-bcm-recommended-actions&version=3.1114.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1114.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+vJLqnMAItaQX1zHjBA9wL+Z3SdwVsge/lui8GKvLTYaNkFwNbK9pdUVGOScB+ej
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bcm-recommended-actions": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1114.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-recommended-actions@3.1114.0/index.min.mjs": "sha384-+vJLqnMAItaQX1zHjBA9wL+Z3SdwVsge/lui8GKvLTYaNkFwNbK9pdUVGOScB+ej"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bcm-recommended-actions/blob/refs/tags/3.1114.0/LICENSE
```
